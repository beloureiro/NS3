...
const ActionPlanApp = ({ language }) => {
  ...
  return (
    <div className="w-full bg-black min-h-screen text-gray-300 font-sans antialiased p-6">
      {/* Main container with different background */}
      <div className="w-full bg-[#111111] border border-[#222222] rounded-lg overflow-hidden">
        {/* Header section */}
        <div className="border-b border-[#222222]">
          <div className="p-8 text-center">
            <h1 className="text-4xl font-bold text-[#00ff9d] mb-2">{t.title}</h1>
            <p className="text-lg text-[#f1f5f9] italic mb-6">
              {t.subtitle}
            </p>
            <ImportExportButtons
