...
import './App.css'; // Adicione seu CSS personalizado aqui
    ...
    <ResponsiveContainer width="100%" height={400}>
      <RadarChart cx="50%" cy="50%" outerRadius="80%" data={animateData}>
        ...
        <Radar
          ...
          dataKey="value"
          stroke={expertiseAreas[activeArea].color}
          fill={expertiseAreas[activeArea].color}
          fillOpacity={0.6}
        />
      </RadarChart>
    </ResponsiveContainer>
    ...
    <div className="w-full max-w-4xl text-center">
      ...
      <div className="mb-12">
        ...
        <p className="leading-relaxed">
          Explore our dynamic range of skills across key business domains. Our expertise is tailored to elevate your
          business performance through innovative solutions and strategic insights.
        </p>
      </div>
